...
def main():
    ...
    with open('ensemble_clustered_models_1101.pkl', 'wb') as f:
        pickle.dump({
            'models': models,
    ...
    train_data.to_csv('l3_train.csv', index=False)
    logging.info("Training data with ref_price saved to l3_train.csv")
    ...
    test_data.to_csv('l3_test.csv', index=False)
    logging.info("Test data with ref_price saved to l3_test.csv")
