...
def main():
    ...
    for cluster in range(len(cluster_info)):
        ...
        for model_dict in cluster_models:
            ...
            try:
                ...
                preds = (preds_lgb + preds_cb + preds_gb) / 3.0
    ...
    submission.to_csv('./1026_ensemble_clustered_optimized.csv', index=False)
    logging.info("Predictions complete. Submission file saved as '1026_ensemble_clustered_optimized.csv'.")
