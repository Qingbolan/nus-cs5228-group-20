...
def main():
    ...
    model.save_model('./lightgbm_model_selective_standardized.txt')
    with open('preprocessing_objects_selective_standardized.pkl', 'wb') as f:
    ...
    submission.to_csv('./submission_lightgbm_selective_standardized.csv', index=False)
    print("Prediction completed. Submission saved to 'submission_lightgbm_selective_standardized.csv'")
