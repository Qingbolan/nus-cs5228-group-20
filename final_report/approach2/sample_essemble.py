...
def main():
    ...
    submission_path = os.getenv('FINAL_REPORT_APPROACH_two_essemble_WEIGHT_PATH', 'final_report\\approach2\\final_report_submission.csv')
    models_save_path = os.getenv('FINAL_REPORT_APPROACH_two_SUBMISSION_PATH', 'final_report\\approach1\\without_cluster\\lightgbm_models.pkl')
    ...
    logging.info(f"Models and preprocessors saved to: {models_save_path}")
    ...
    rsme = calculate_rmse(submission_path)
    logging.info(f'RMSE: {rsme}')
